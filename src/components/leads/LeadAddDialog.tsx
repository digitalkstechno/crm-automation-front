...
//   /**
//    * Immediately calls the DELETE /leads/:leadId/attachments/:attachmentId API.
//    * Shows a per-attachment spinner while in-flight.
//    * On success, removes it from local state so the UI updates instantly.
//    */
//   const handleDeleteExistingAttachment = async (attachment: Attachment) => {
//     console.log(attachment,'jkslkmjdpj');
//     const attachmentId = attachment._id || attachment.path;
//     if (!initialData?._id) return;

//     // Confirm before deleting
//     if (!window.confirm(`Delete "${attachment.originalName || attachment.name || 'this file'}"? This cannot be undone.`)) {
//       return;
//     }
...
//                             disabled={isDeleting}
//                             className="p-1.5 text-blue-600 hover:text-blue-800 hover:bg-blue-50 rounded-lg transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
//                             title="View"
//                           >
...
//                             disabled={isDeleting}
//                             className="p-1.5 text-green-600 hover:text-green-800 hover:bg-green-50 rounded-lg transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
//                             title="Download"
//                           >
//                             <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
//                             disabled={isDeleting}
//                             className="p-1.5 text-red-600 hover:text-red-800 hover:bg-red-50 rounded-lg transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
//                             title="Delete"
//                           >
//                             {isDeleting ? (
...
//                       <button
//                         type="button"
//                         onClick={() => handleRemoveNewFile(file , i)}
//                         className="p-1.5 text-red-600 hover:text-red-800 hover:bg-red-100 rounded-lg transition-colors ml-4"
//                         title="Remove"
//                       >
//                         <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
