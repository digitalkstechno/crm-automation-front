...
//               className="w-full rounded-lg border border-gray-600 bg-[#0f172a] py-3 px-4 text-white placeholder-gray-400 outline-none transition focus:border-[#5b77f1] focus:ring-2 focus:ring-[#5b77f1]/50"
//             />
//           </div>
...
//                 className="w-full rounded-lg border border-gray-600 bg-[#0f172a] py-3 px-4 pr-10 text-white placeholder-gray-400 outline-none transition focus:border-[#5b77f1] focus:ring-2 focus:ring-[#5b77f1]/50"
//               />
//               <button
//                 type="button"
